...
def transform_input_payload(balloons, cars, people, groups, history):
    balloons = _transform_list(balloons, {
        'id': 'id',
    ...
    return balloons, cars, people, precluster, frozen, history,


def _transform_vehicle_groups(groups: list[dict]) -> tuple[dict[str, list[str]], list[dict[str, str]]]:
    """
...
def transform_output(
    vehicle_info: dict[str, dict[str, str]],
